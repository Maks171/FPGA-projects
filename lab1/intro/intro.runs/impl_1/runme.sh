...
HD_PWD='/home/lsriw/SR/FilipMaksymilian/lab1/intro/intro.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log introduction.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source introduction.tcl -notrace
