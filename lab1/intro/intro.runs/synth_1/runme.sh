...
HD_PWD='/home/lsriw/SR/FilipMaksymilian/lab1/intro/intro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log introduction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source introduction.tcl
